...
const NoConversationPlaceholder = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-8 bg-zinc-950 select-none">
      ...
      {/* SECURITY INDICATOR */}
      <div className="mt-16 flex items-center gap-2.5 px-5 py-2.5 bg-zinc-900/30 border border-zinc-800/50 rounded-xl transition-colors hover:border-yellow-500/20">
      ...
      <div className="absolute bottom-6 right-6 opacity-10">
        <div className="text-[10px] font-mono text-yellow-500 text-right">
          v1.0.0 // 2026<br />
          SAYHAI
        </div>
      </div>
